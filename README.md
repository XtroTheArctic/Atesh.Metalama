...
* **Metalama:** The purpose of Atesh.Metalama library is to add additional features to Metalama by providing new aspects. Metalama is a commercial product which is a modern replacement for PostSharp: https://www.postsharp.net/metalama.\s\s
Metalama offers a free license so you can use community aspects such as the ones in Atesh.Metalama free of charge.\s\s
