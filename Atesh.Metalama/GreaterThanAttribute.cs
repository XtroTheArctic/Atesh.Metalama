...
#pragma warning disable CS8602
        if (value.CompareTo(Value1) <= 0) throw new ArgumentOutOfRangeException(((INamedDeclaration)meta.Target.Declaration).Name, value, Strings.ValueMustBeGreaterThan(Value1.ToString()));
