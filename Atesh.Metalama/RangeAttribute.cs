...
#pragma warning disable CS8602
        if (value.CompareTo(Value1) < 0 || value.CompareTo(Value2) > 0) throw new ArgumentOutOfRangeException(((IParameter)meta.Target.Declaration).Name, Strings.ValueMustBeBetween(Value1.ToString(), Value2.ToString()));
